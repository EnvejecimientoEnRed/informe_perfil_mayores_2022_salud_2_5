...
export function initChart() {
    ///Lectura de datos
    d3.csv('https://raw.githubusercontent.com/EnvejecimientoEnRed/informe_perfil_mayores_2022_salud_2_5/main/data/tasas_morbilidad_hospitalaria_2020.csv', function(error,data) {
